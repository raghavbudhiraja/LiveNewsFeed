...
Content-First: News articles are the hero - everything serves content discovery
Scannable Hierarchy: Clear visual distinction between headlines, metadata, and body text
Information Density: Maximize content visibility without overwhelming users
Dual Theme Mastery: Both light and dark modes feel native, not afterthoughts
Typography System
Primary Font: Inter or Roboto (Google Fonts CDN) Secondary Font: Georgia or Merriweather for article preview text (readability)
...
2. Search Bar
Placement: Integrated into navbar Design:
...
Category badge: Small pill badge, text-xs px-3 py-1 rounded-full
Article image: Full-width, mb-4
Title: text-xl font-semibold mb-3, 2-line clamp
Description: text-base mb-4, 3-line clamp, secondary font
Metadata row: Flex layout with source and date
Source icon + name: flex items-center gap-2
Separator dot: mx-2
Published date: Relative time (e.g., "2 hours ago")
"Read More" link: text-sm font-medium with arrow icon (Heroicons arrow-right)
Card Variants:
...
Featured hero article: Top of homepage, large image with text overlay
Article cards: Each card includes thumbnail image at top
No images needed: Navbar, footer, loading states, error states
Layout Specifications
Navbar: h-16 fixed, full-width, blur background in dark mode Content area: pt-20 (to clear fixed navbar) Article grid gap: gap-8 desktop, gap-6 mobile Card border-radius: rounded-lg (8px) for modern feel Container padding: px-4 lg:px-8 consistent throughout
